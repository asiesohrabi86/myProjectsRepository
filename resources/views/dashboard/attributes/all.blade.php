                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <a href="{{route('attributes.create')}}" class="btn btn-success offset-lg-8 mb-1">افزودن ویژگی جدید</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="row">
                                            <form action="{{route('attributes.destroy',$attribute->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" onclick="return confirm('آیا از حذف ویژگی مطمئن هستید؟')" class="btn btn-danger btn-sm" style="margin-left: 5px">حذف</button>
                                            </form>
                                          <a href="{{route('attributes.edit',$attribute->id)}}" class="btn btn-primary btn-sm" style="margin-left: 5px">ویرایش</a> 
                                          <a href="{{route('attribute.get.values',$attribute->id)}}" class="btn btn-success btn-sm">افزودن مقدار</a> 
