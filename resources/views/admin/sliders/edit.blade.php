                    ...
                    <div class="panel-body">
                        <form action="{{route('sliders.update',$slider->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('description') is-inalid' @enderror" id="exampleInputPassword1" placeholder="متن اسلایدر را وارد نمایید" name="description" value="{{$slider->description}}">
